...
func main() {
	array1 := [...]string{"Almond Biscotti Café", "Banana Pudding", "Balsamic Strawberry (GF)",
	...
	fmt.Println(array1)
	fmt.Println("\nThe length of array1 is:", len(array1))

	fmt.Println("Playing with for range loop over array1:")
